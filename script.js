...
let progressUpdate = document.getElementById("budget-progress");
...
function changeBackgroundColor() {
  // Percents
  let twentyFivePercent = budgetInput.value * 0.25;
  console.log(twentyFivePercent);
  let tenPercent = budgetInput.value * 0.1;
  console.log(tenPercent);
  if (
    Number(remainingBalance.innerText) <= twentyFivePercent &&
    Number(remainingBalance.innerText) > tenPercent
  ) {
    budgetMain.style.backgroundColor = "#fabc3c";
    body.style.backgroundColor = "#fabc3c";
    // progressUpdate.style.backgroundColor = "#fabc3c";
    foodBar.style.backgroundColor = "#fabc3c";
